...
namespace VisiLog.Data.Contracts.Repositories
{
    ...
    public interface ILogMessageRepository
    {
        ...
        Task<IReadOnlyList<LogMessage>> GetRecentAsync(int count, CancellationToken cancellationToken = default);
        ...
        Task<LogMessage?> GetByIdAsync(int id, CancellationToken cancellationToken = default);
